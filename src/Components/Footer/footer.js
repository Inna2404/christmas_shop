...
<footer class="footer_section">
  ...
  <div class="networks">
    <div class="networks_imgs">
      <a href="https://web.telegram.org/" target="_bank" class="networks_link">
        <svg
          class="networks_img"
          width="24"
          height="24"
      ...
      <a href="https://www.facebook.com/" target="_bank" class="networks_link">
        <svg
          class="networks_img"
          width="24"
          height="24"
      ...
      <a href="https://www.instagram.com/" target="_bank" class="networks_link">
        <svg
          class="networks_img"
          width="24"
          height="24"
      ...
      <a href="https://x.com/" target="_bank" class="networks_link">
        <svg
          class="networks_img"
          width="24"
          height="24"
        ...
        >
          <path
            ...
            stroke-width="1.5"
          ></path>
          <path d="M20 3L4 21" stroke-width="1.5" stroke-linecap="round"></path>
        </svg>
      </a>
    </div>
    <div class="networks_text">
